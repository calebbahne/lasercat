...
// Path generator
#define SEGMENT_AMOUNT 100       // Number of segments in the path
#define NUM_CURVE_POINTS 20      // Number of points for curved segments
#define NUM_STRAIGHT_POINTS 20   // Number of points for the final straight segment
...
bool homeSteppers() {
  ...
  Serial.println(F("Both steppers homed."));
