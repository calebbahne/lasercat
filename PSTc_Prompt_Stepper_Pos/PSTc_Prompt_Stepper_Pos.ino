...
void promptToPos(){
  Serial.println("Enter a position for X: ");
  xyPos[0] = getInput();           //Relative
  Serial.print("X Input: ");
  Serial.println(xyPos[0]); 
  Serial.println("Enter a position for Y: ");
  xyPos[1] = getInput();           //Relative
