...
bool randomPathMode() {
  ...
  generatePath(50, 20, 20, 150, 2000);  // (int segAmt, int numCurvPts, int numStrtPts, int speed, int stopTime, Point* start = nullptr)
  digitalWrite(laserPin, LOW);
  returnToMenu();
}
...
bool setFourCorners() {
  ...
  if (pressCount == 4) {
    ...
    /*
    Serial.print(F("XC= "));
    Serial.print(xCenterPos);
    Serial.print(F(" YC= "));
    Serial.print(yCenterPos);
    */
